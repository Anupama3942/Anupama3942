...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Hey%20There!%20I'm%20a%20Dev%20%F0%9F%91%8B&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Developer%20%26%20Automation%20Architect&descAlignY=55&descSize=20" width="100%"/>
...
class Developer:
    ...
    def current_focus(self):
        return [
            ...
            "⚙️  Scalable backend automation & real-time data scraping",
            "🐧 Optimized Linux-powered development workflows",
        ]
```
...
<table>
  <tr>
    <td width="50%">
      ...
      <p>Developing high-efficiency mobile applications using React Native that deliver native-like performance on both iOS and Android from a single codebase.</p>
    </td>
    <td width="50%">
      <h3>⚙️ Backend Automation</h3>
      <p>Designing scalable backend systems with real-time data scraping solutions using Python, Flask, and BeautifulSoup4 to automate complex workflows.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>🐧 Linux-Powered Workflows</h3>
      <p>Leveraging Fedora Linux and Bash scripting to build optimized, reproducible development environments and automation pipelines.</p>
    </td>
    <td width="50%">
      <h3>🤖 Telegram Bot Ecosystems</h3>
      <p>Building intelligent Telegram bots that integrate with real-world data sources and automate information delivery to end users.</p>
    </td>
  </tr>
</table>
